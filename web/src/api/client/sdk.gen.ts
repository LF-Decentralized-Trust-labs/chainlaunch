 ...
 */
export const getNetworksFabricByIdBlocksByBlockNumTransactions = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricByIdBlocksByBlockNumTransactionsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetNetworksFabricByIdBlocksByBlockNumTransactionsResponse, GetNetworksFabricByIdBlocksByBlockNumTransactionsError, ThrowOnError>({
...
/**
 * Initialize CRL for an organization
 * Initialize a new Certificate Revocation List for the organization
 */
export const postOrganizationsByIdCrlInitialize = <ThrowOnError extends boolean = false>(options: Options<PostOrganizationsByIdCrlInitializeData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostOrganizationsByIdCrlInitializeResponse, PostOrganizationsByIdCrlInitializeError, ThrowOnError>({
