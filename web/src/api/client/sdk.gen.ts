...
/**
 * List deployed Fabric chaincodes with Docker/runtime info
 * List all Fabric chaincodes deployed via Docker, including container status and runtime details
 */
...
/**
 * Get Fabric chaincode details by slug
 * Get a specific Fabric chaincode and its Docker/runtime info by slug
 */
export const getScFabricChaincodesBySlug = <ThrowOnError extends boolean = false>(options: Options<GetScFabricChaincodesBySlugData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetScFabricChaincodesBySlugResponse, GetScFabricChaincodesBySlugError, ThrowOnError>({
