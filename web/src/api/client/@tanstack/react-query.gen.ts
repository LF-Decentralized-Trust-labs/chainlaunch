...
export const getApiV1MetricsStatusQueryKey = (options?: Options<GetApiV1MetricsStatusData>) => [
    createQueryKey('getApiV1MetricsStatus', options)
];

export const getApiV1MetricsStatusOptions = (options?: Options<GetApiV1MetricsStatusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
