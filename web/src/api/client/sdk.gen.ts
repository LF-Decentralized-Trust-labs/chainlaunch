 ...
 * Retrieves metrics for a specific node by ID
 */
...
/**
 * Refresh the list of nodes to be scraped
 * Updates the list of nodes that Prometheus should scrape
 */
export const postApiV1MetricsRefresh = <ThrowOnError extends boolean = false>(options: Options<PostApiV1MetricsRefreshData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiV1MetricsRefreshResponse, PostApiV1MetricsRefreshError, ThrowOnError>({
